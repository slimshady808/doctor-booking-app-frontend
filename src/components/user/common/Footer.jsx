          ...
          <div className="   grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <path d="M179.06,19.254c-5.123-8.873-14.298-14.17-24.544-14.17v10c6.631,0,12.568,3.428,15.884,9.17
              ...
              <div className="mt-6 lg:max-w-sm">
                ...
                DocTime: Your go-to app for healthcare appointments.
                 Easily find and book appointments with trusted doctors,
                  
                </p>
                <p className="mt-4 text-sm text-gray-800">
                manage your medical visits with simplicity,
            ...
            <div>
              ...
              Stay connected with us on social media for the latest updates, health tips, and more!
              </p>
            </div>
          </div>
